...
class symbol_classifier(nn.Module):
    def __init__(self, params):
        super(symbol_classifier, self).__init__()
        self.linear = nn.Linear(in_features=params['D'], out_features=params['K'])
...
class Encoder_Decoder(nn.Module):
    def __init__(self, params):
        ...
        self.classifier = symbol_classifier(params)
